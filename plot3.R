...
#generate graph
with(data,plot(DatewithTime, Sub_metering_1, type="l", col="black",
     xlab="", ylab="Energy sub metering"))
with(data,lines(DatewithTime, Sub_metering_2, col="red"))
with(data,lines(DatewithTime, Sub_metering_3, col="blue"))
legend("topright",
